              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('pages/overzicht') ? ' active' : '' }}" href="/pages/overzicht">
                    ...
                    <a class="nav-main-link{{ request()->is('pages/nieuwsbrief') ? ' active' : '' }}" href="/pages/nieuwsbrief">
                        <span class="nav-main-link-name">Nieuwsbrief</span>
                    </a>
                    <a class="nav-main-link{{ request()->is('pages/bewerknieuwsbrief') ? ' active' : '' }}" href="/pages/bewerknieuwsbrief">
