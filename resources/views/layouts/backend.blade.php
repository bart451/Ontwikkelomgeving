...
<div id="page-container"
     class="sidebar-o sidebar-mini enable-page-overlay sidebar-dark side-scroll page-header-fixed main-content-narrow">
    <!-- Side Overlay-->
    <aside id="side-overlay" class="fs-sm">
        ...
        <div class="content-header border-bottom">
            ...
            <!-- User Info -->
            <div class="ms-2">
                <a class="text-dark fw-semibold fs-sm" href="javascript:void(0)">bart de jonge</a>
            </div>
            <!-- END User Info -->
        ...
        <div class="content-header">
          ...
          <span class="smini-visible">
            <i class="fa fa-circle-notch text-primary"></i>
                ...
                <span class="smini-hide fs-5 tracking-wider">C3OSX<span class="fw-normal"></span></span>
            </a>
            <!-- END Logo -->
                    ...
                    <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                ...
                                <a class="nav-main-link{{ request()->is('pages/bewerknieuwsbrief') ? ' active' : '' }}"
                                   href="/pages/bewerknieuwsbrief">
                                    <span class="nav-main-link-name">bewerk Nieuwsbrief</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="dropdown d-inline-block ms-2">
                    <button type="button" class="btn btn-sm btn-alt-secondary d-flex align-items-center"
                        ...
                        <img class="rounded-circle" src="{{ asset('media/avatars/avatar10.jpg') }}" alt="Header Avatar"
                             style="width: 21px;">
                        <span class="d-none d-sm-inline-block ms-2">Bart</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0"
                        ...
                        <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                            ...
                            <p class="mt-2 mb-0 fw-medium">Bart de Jonge</p>
